...
import { EventBusy as EventBusyIcon } from '@mui/icons-material'; // Import the EventBusy icon
import HomepageEventsDate from './DateHomepage';
import MobileHomepageEvents from './MobileEventsHomepage';
	...
	return (
		<div className="events">
			<Box>
				...
				{!noUpcomingEvents && <HomepageEventsDate />}
			</Box>
